...
A small agentic automation project that watches a folder on your Mac, and whenever a new file lands in it, uses a local AI model to figure out what the document actually is and what should happen next.
